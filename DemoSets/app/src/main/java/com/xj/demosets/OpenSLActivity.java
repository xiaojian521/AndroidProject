...
public class OpenSLActivity extends Activity {
    ...
    private static final int AUDIO_ECHO_QERUEST = 0;
...
// initialize URI spinner
        ...
        ((Button) findViewById(R.id.hello)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.android)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                // ignore the return value
        ...
        ((Button) findViewById(R.id.sawtooth)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                // ignore the return value
        ...
        ((Button) findViewById(R.id.reverb)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.embedded_soundtrack)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.uri_soundtrack)).setOnClickListener(new View.OnClickListener() {
            boolean created = false;
            public void onClick(View view) {
                if (!created && URI != null) {
        ...
        ((Button) findViewById(R.id.pause_uri)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                setPlayingUriAudioPlayer(false);
            }
        });

        ((Button) findViewById(R.id.play_uri)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                setPlayingUriAudioPlayer(true);
            }
        });

        ((Button) findViewById(R.id.loop_uri)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.mute_left_uri)).setOnClickListener(new View.OnClickListener() {
            boolean muted = false;
            public void onClick(View view) {
                muted = !muted;
        ...
        ((Button) findViewById(R.id.mute_right_uri)).setOnClickListener(new View.OnClickListener() {
            boolean muted = false;
            public void onClick(View view) {
                muted = !muted;
        ...
        ((Button) findViewById(R.id.solo_left_uri)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.solo_right_uri)).setOnClickListener(new View.OnClickListener() {
            boolean soloed = false;
            public void onClick(View view) {
                soloed = !soloed;
        ...
        ((Button) findViewById(R.id.mute_uri)).setOnClickListener(new View.OnClickListener() {
            boolean muted = false;
            public void onClick(View view) {
                muted = !muted;
        ...
        ((Button) findViewById(R.id.channels_uri)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (numChannelsUri == 0) {
                    numChannelsUri = getNumChannelsUriAudioPlayer();
                }
                Toast.makeText(OpenSLActivity.this, "Channels: " + numChannelsUri,
...
//                        }
        ...
        ((Button) findViewById(R.id.playback)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                // ignore the return value
