...
/*
 * Only support up-sampling, 仅支持向上采样
 */
short* createResampledBuf(uint32_t idx, uint32_t srcRate, unsigned *size) {
    ...
    //创建多少个字节 short数组的数量*重采样系数 8000->16000
    ...
    for(int sample=0; sample < srcSampleCount; sample++) {
        for(int dup = 0; dup  < upSampleRate; dup++) {
            //将数据内容放入创建的resamplebuf中
            *workBuf++ = src[sample];
        }
    }
    //short数组数量*采样系数，也就是重采样后的字节个数
...
Java_com_xj_demosets_OpenSLActivity_createEngine(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_createBufferQueueAudioPlayer(JNIEnv* env,
...
Java_com_xj_demosets_OpenSLActivity_createUriAudioPlayer(JNIEnv* env, jclass clazz,
        jstring uri)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_setPlayingUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_setLoopingUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_setChannelMuteUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_setChannelSoloUriAudioPlayer(JNIEnv* env,
...
Java_com_xj_demosets_OpenSLActivity_getNumChannelsUriAudioPlayer(JNIEnv* env, jclass clazz)
{
    SLuint8 numChannels;
    SLresult result;
    SLMuteSoloItf muteSoloItf = getMuteSolo();
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_setVolumeUriAudioPlayer(JNIEnv* env, jclass clazz,
        jint millibel)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_setMuteUriAudioPlayer(JNIEnv* env, jclass clazz,
        jboolean mute)
{
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_enableStereoPositionUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_setStereoPositionUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT jboolean JNICALL
Java_com_xj_demosets_OpenSLActivity_enableReverb(JNIEnv* env, jclass clazz,
        jboolean enabled)
{
    SLresult result;
...
JNIEXPORT jboolean JNICALL
Java_com_xj_demosets_OpenSLActivity_selectClip(JNIEnv* env, jclass clazz, jint which,
        jint count)
{
...
JNIEXPORT jboolean JNICALL
Java_com_xj_demosets_OpenSLActivity_createAssetAudioPlayer(JNIEnv* env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_setPlayingAssetAudioPlayer(JNIEnv* env,
        jclass clazz, jboolean isPlaying)
{
    SLresult result;
...
JNIEXPORT jboolean JNICALL
Java_com_xj_demosets_OpenSLActivity_createAudioRecorder(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_startRecording(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_xj_demosets_OpenSLActivity_shutdown(JNIEnv* env, jclass clazz)
{
