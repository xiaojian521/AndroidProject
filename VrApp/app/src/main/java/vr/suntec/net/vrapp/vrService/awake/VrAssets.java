...
public class VrAssets {
    protected static final String TAG = VrAssets.class.getSimpleName();
    ...
    public VrAssets(Context context) throws IOException {
    ...
    public VrAssets(Context context, String dest) {
